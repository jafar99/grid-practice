...
import './App.css';
import image from './Image/image-daniel.jpg';
...
function App() {
  return (
    ...
    <article class="testimonial flow bg-neutral-100 text-secondary-400">
      <div class="flex">
        <div>
          <img src={image} alt="Jeanette Harmon" />
        </div>
        <div>
    ...
    <article class="testimonial grid-col-span-2 flow bg-secondary-500 text-neutral-100">
      <div class="flex">
        <div>
          <img class="border-primary-400" src={image}alt="Patrick Abrams"/>
        </div>
        <div>
    ...
    <article class="testimonial flow bg-neutral-100 text-secondary-400">
      <div class="flex">
        <div>
          <img src={image} alt="Kira Whittle"  />
        </div>
        <div>
